#!/usr/bin/env python3
"""
Test script for MultiTalk Minimal
"""
...
def test_multitalk_minimal():
    """Test MultiTalk Minimal deployment"""
    print("🧪 Testing MultiTalk Minimal...")
    
    try:
        # Get the deployed class
        MultiTalkMinimal = modal.Cls.lookup("multitalk-minimal", "MultiTalkMinimal")
        ...
        # Test generation
        result = MultiTalkMinimal().generate_video.remote(
...
if __name__ == "__main__":
    success = test_multitalk_minimal()
    if success:
